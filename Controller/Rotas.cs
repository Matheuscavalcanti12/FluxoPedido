...
public static void NovoCadastro(this WebApplication app)
{
    app.MapPost("/cadastro", (Usuario usuario) =>
    {
           ...
           int usuarioId = Convert.ToInt32(cmdId.ExecuteScalar());

           // Gerar token JWT
           try
           {
               var token = JWT.GenerateToken(usuario.Email, "user");
...
public static class DeletarProdutoBanco
{
    public static void DeletarProduto(this WebApplication app)
    {
